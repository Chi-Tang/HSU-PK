...
'  cmd.Execute
 ...
 '  SQLU ="Update "&Lesson&"K"&" Set 標記=-1"  
  ...
  '/ Response.Write LYGG
' Response.Redirect "Excer22-sn.asp?" & "YKK=" & YKKN & "&" & "YKG=" & YKKG& "&" & "LYG=" & LYGG & "&" & Request.QueryString
...
////////////////////////////////////////
 ...
 var sDat,lDat,str1,str2 ;
   cldt = new calendar(SYY,SMM);
      //sD = i - cldt.firstWeek;
     sD = TDD ;
     lDat = new Date(cldt[sD].lYear,cldt[sD].lMonth,cldt[sD].lDay);
     sDat = new Date(cldt[sD].sYear,cldt[sD].sMonth,cldt[sD].sDay);
  ...
  if(sD>-1 && sD<cldt.length) {
   ...
   //st1+st2+st3;
     // sk ='　歲次：'+cldt[sD].cYear ;
       str1 = lDat.toDateString(1);
       str2 = sDat.toDateString(1);
       str1='農'+str1.substring(4,10);
       str2='現'+str2.substring(4,10);
...
var xlsheet = xlBook.Worksheets(1); 
 ...
 xlsheet.Cells(1,1).value = " hellow";
 
 xlsheet.SaveAs("C:\\TEST3.XLS");	
...
<script> 
  //document.write(saveToExcel("Exce222"));
  saveToExcel("testsExce");
</script> 
</html>
