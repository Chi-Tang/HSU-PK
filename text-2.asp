...
Set rs = GetExcelRecordset( "Excel02.xls",  SQLD)
...
End If 
 ...
 'Dim xlapp 
 ' Set xlapp = Server.CreateObject( "Excel.Applcation" )
 'xlapp.visible = True
 ' xlapp.delete("C:\\TEST.XLS")
 ' xlapp.Quit
'' On Error Resume Next 
...
////////////////////////////////////////
 //var sk,st11,st22, cldt,cldt1,cldt2;
...
//  ExcelSheet.ActiveSheet.Cells(p2+j+1,9).Value = cldt2[j].cDay;
 ...
 /// 儲存該工作表。
 // ExcelSheet.SaveAs("C:\\TEST"+Nyy+".XLS");	
