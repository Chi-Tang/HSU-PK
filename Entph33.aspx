  ...
  <Table border="1" cellpadding="2" cellspacing="0">
    ...
    <tr>
      ...
      <asp:ListBox runat="server" id="HSNUM" size="6">
        <asp:ListItem>坎</asp:ListItem><asp:ListItem>坤</asp:ListItem><asp:ListItem>震</asp:ListItem><asp:ListItem>巽</asp:ListItem><asp:ListItem>中</asp:ListItem>
       <asp:ListItem>乾</asp:ListItem><asp:ListItem>兌</asp:ListItem><asp:ListItem>艮</asp:ListItem><asp:ListItem>離</asp:ListItem>
      </asp:ListBox></td>
    </tr>
