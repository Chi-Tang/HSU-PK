...
If Request("Send") <> Empty Then
 ...
 ' Response.Write "<TR><TD>年干:"&YKKN & "</TD></TR>"
  ...
  Response.Redirect "Excer2-pk.asp?" & "YKK=" & YKKN & "&" & "YKG=" & YKKG& "&" & "LYG=" & LYGG & "&" & Request.QueryString
...
<blockquote>
    <form action="<%=Myself%>" method="GET"> 
        ...
        <p>請輸入第三(變)數：<input type="integer" size="20" name="No3" Value="<%=No3%>"></p> 
 ...
 <!---   姓名：<input type="text" size="20" name="Name"  Value="<%=Name%>"> --> 
      ...
      <h5> 卜卦日期西元?年 　 &月份              &日號            &時辰                      &出生年西元?年 :</h5>                                                                                                                                                                                                               
...
<center><a href="http://www.ineedhits.com/free-tools/submitfree.aspx?source=FTSFbutton"><img src="http://www.ineedhits.com/images/trackingbuttons/SFbutton.gif?ref=1563375" border="0" height="32" width="90" alt="Submit your website to 20 Search Engines - FREE with ineedhits!"></a></center>
<%  
