  ...
  <Table border="1" cellpadding="2" cellspacing="0">
    ...
    <tr>
      ...
      <asp:ListBox runat="server" id="HSNUM" size="6">
        <asp:ListItem>坐坎向離</asp:ListItem><asp:ListItem>坐坤向艮</asp:ListItem><asp:ListItem>坐震向兌</asp:ListItem><asp:ListItem>坐巽向乾</asp:ListItem><asp:ListItem>中</asp:ListItem>
