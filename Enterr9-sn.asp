...
<% If Request("Send") = Empty Then %>
   <FORM Action=Forma-2.asp Method=POST>
...
''''''''''''''''''''''''''''''''''''''''''''''''''''''''''' 
 ...
 ''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
 '''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
  Dim KLunar,KPLunar , KLNART
   Klunar=Lunar(Syern,Smohn,Sdatn)
    KPLunar=split(Klunar,";")
    KSyern=KPLunar(0)
    KSmohn=KPLunar(1)
    KSdatn=KPLunar(2)
    KSdlep=KPLunar(3)
   ...
   '' Response.write SLunar& SPLunar(3)
    Response.write KLunar
   ''KLNART = KLnar(2012,1,20,"false")
    KLNART = KLnar(KSyern,KSmohn,KSdatn,KSdlep)
    Response.write KLNART 
'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
    Dim KGLunar,KGPLunar , KGLnart
     KGLunar=KLunar(Syern,Smohn,Sdatn)
    ...
    KGLnart=Tcalendar(KGyern,KGmohn,KGdatn)
   
   '' Response.write KGLunar& KGPLunar(3)
    Response.write  KGLnart
