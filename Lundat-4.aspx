...
<meta http-equiv="Content-Type" content="text/html; charset=big5">
 <%
 LunData = Array("0A4D0","0D250","1D295","0B550","056A0","0ADA2","095B0","14977",
"049B0","0A4B0","0B4B5","06A50","06D40","1AB54","02B60","09570","052F2","04970", 
...
"0A950","0B4A0","0BAA4","0AD50","055D9","04BA0","0A5B0","15176","052B0","06930",
"07954","06AA0","0AD50","05B52","04B60","0A6E6","0A4E0","0D260","0EA65","0D520",
"0DAA0","076A3","096D0","04AFB","04AD0","0A4D0","1D0B6","0D250","0D520","0DD45",
  ...
  if(nObj.innerHTML!='') {
   ...
   if(cld[d].sYear>1911) yDisplay = '民國' + (((cld[d].sYear-1911)==1)?'元':cld[d].sYear-1911);
    ...
    s='　歲次：' +cld[d].cYear+'年 '+cld[d].cMonth+'('+cld[d].jMonth+')'+'月 '+cld[d].cDay + ' 日';
        ...
        alert("ok,ok");
       //document.write (s);
       document.write(DATCld(2012,9,6));
        //DATCld(2012,10,10);
