...
<%@ Import Namespace="System.Web.Mail" %>
 ...
 <%
     ...
     Dim TNam, TNsx, TNhs,TNhs1,TNhs2, InpLn, InpSFx, InpSx, InpFx, InpAnd, InpAsx, InpAfx
  ...
  TNsx = Request("Sex")
     ...
     While Rhs.Read()
         If Rhs.Item(0) = TNhs Then ' 表示此一 Email 存在 ''''不可空(記祿)列
