...
'  cmd.Execute
 ...
 Response.Redirect "Excer2-2.asp?" & "YKK=" & YKKN & "&" & "YKG=" & YKKG& "&" & "LYG=" & LYGG & "&" & Request.QueryString
...
<blockquote>
    <form action="<%=Myself%>" method="GET"> 
       ...
       <!--<p>再輸入帳號(確認)：<input type="text" size="20" name="No" Value="<%=No%>"></p>-->     
